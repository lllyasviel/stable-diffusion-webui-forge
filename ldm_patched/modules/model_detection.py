...
def convert_diffusers_mmdit(state_dict, output_prefix=""):
    ...
    if 'joint_transformer_blocks.0.attn.add_k_proj.weight' in state_dict: #AuraFlow
        ...
        sd_map = ldm_patched.modules.utils.flux_to_diffusers({"depth": depth, "depth_single_blocks": depth_single_blocks, "hidden_size": hidden_size}, output_prefix=output_prefix)
