...
def finalize_default_conds(model: 'BaseModel', hooked_to_run: dict[ldm_patched.hooks.HookGroup,list[tuple[tuple,int]]], default_conds: list[list[dict]], x_in, timestep):
    ...
    for i, mult in enumerate(default_mults):
        ...
        for x in cond:
            ...
            p = ldm_patched.modules.samplers.get_area_and_mult(x, x_in, timestep)
            if p is None:
                continue
...
KSAMPLER_NAMES = ["euler", "euler_cfg_pp", "euler_ancestral", "euler_ancestral_cfg_pp", "heun", "heunpp2","dpm_2", "dpm_2_ancestral",
                  "lms", "dpm_fast", "dpm_adaptive", "dpmpp_2s_ancestral", "dpmpp_sde", "dpmpp_sde_gpu", "dpmpp_2s_ancestral_cfg_pp"
