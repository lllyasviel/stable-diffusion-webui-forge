...
class Flux(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        ...
        if t5_key in state_dict:
            dtype_t5 = state_dict[t5_key].dtype
        return supported_models_base.ClipTarget(ldm_patched.modules.text_encoders.flux.FluxTokenizer, ldm_patched.modules.text_encoders.flux.flux_clip(dtype_t5=dtype_t5))
