    ...
    with closing(p):
        if is_batch:
            if img2img_batch_source_type == "upload":
                ...
                output_dir = p.outpath_samples if img2img_batch_upload_use_original_name_option else ""
                inpaint_mask_dir = ""
