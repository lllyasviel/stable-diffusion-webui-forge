...
class Toprow:
    ...
    def create_tools_row(self):
        with gr.Row(elem_id=f"{self.id_part}_tools"):
            ...
            self.apply_styles = ToolButton(value=ui_prompt_styles.styles_materialize_symbol, elem_id=f"{self.id_part}_style_apply", tooltip="Apply all selected styles to prompts. Strips any comments.")
